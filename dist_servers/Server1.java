...
public class Server1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Server1 running on port: " + SERVER_PORT);

            // Thread: Client'tan gelen abonelik bilgilerini al
            new Thread(Server1::acceptClients).start();

            // Thread: Diğer serverlardan gelen abonelik bilgilerini al
            new Thread(Server1::receiveUpdatesFromOtherServers).start();

            // Thread: Admin'e kapasite bilgisi gönder
            new Thread(Server1::sendCapacityPeriodically).start();
